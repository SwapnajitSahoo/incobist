      ...
      <div class="job-card">
        ...
        <div class="job-card-body-flex">
          ...
          <div class="job-info-left">
            <a href="{{ route('career.details', $row->id) }}" style="text-decoration: none;">
          ...
          <div class="apply-section">
            <a href="{{ route('career.apply', $row->id) }}" class="apply-btn"
              style="text-decoration: none; display: inline-block;">Apply Now</a>
