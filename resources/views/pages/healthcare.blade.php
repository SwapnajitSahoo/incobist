<x-guest-layout>
  <x-slot name="title">{{$getIndustry->page_title ?? 'Healthcare'}}</x-slot>
  <section class="high-tech-hero" style>
    <div class="career-heading">
      <h1>{{$getIndustry->heading ?? 'Healthcare'}}</h1>
      <hr class="career-line">
      <p class="career-subtitle">{{$getIndustry->heading_subtitle ?? 'Healthcare'}}</p>
    </div>
  ...
  <div class="lending-speed">
    <h1>{{$getIndustry->lending_title ?? 'Healthcare'}}</h1>
    <hr class="lending-speed-line">
    <p>{{$getIndustry->lending_desc ?? 'Healthcare'}}</p>
  </div>
