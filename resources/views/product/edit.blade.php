                    ...
                    <div class="row gx-4">
                        <div class="col-md-8">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="heading" class="form-control form-control-lg" value="{{ old('heading', $product->heading) }}">
                            </div>

                            <div class="mb-4">
                                <label class="form-label fw-bold">Content</label>
                                <textarea name="content" id="product-content" class="form-control" rows="15">{{ old('content', $product->content) }}</textarea>
                            </div>
                        </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="image-preview-wrapper mb-2">
                                            <div id="image-preview-container" class="border rounded d-flex align-items-center justify-content-center bg-white" style="height: 200px; overflow: hidden;">
                                                 @if($product->image)
                                                     <img id="image-preview" src="{{ asset($product->image) }}" style="max-width: 100%;">
                                        ...
                                        <small class="text-muted">Max: 2MB. Leave empty to keep existing image.</small>
                                    </div>
