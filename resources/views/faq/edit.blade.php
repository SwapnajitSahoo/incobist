                ...
                <div class="row gx-4">
                    <div class="col-md-8">
                        <div class="mb-4">
                            ...
                            <input type="text" name="question" class="form-control form-control-lg" value="{{ old('question', $faq->question) }}" required>
                        </div>

                        <div class="mb-4">
                            <label class="form-label fw-bold">Answer <span class="text-danger">*</span></label>
                            <textarea name="answer" class="form-control" rows="8" placeholder="Enter answer" required>{{ old('answer', $faq->answer) }}</textarea>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                <div class="mb-4">
                                    ...
                                    <select name="faq_type" class="form-control" required>
                                        <option value="corporate" {{ old('faq_type', $faq->faq_type) == 'corporate' ? 'selected' : '' }}>Corporate</option>
                                        <option value="shares" {{ old('faq_type', $faq->faq_type) == 'shares' ? 'selected' : '' }}>Shares</option>
                                    </select>
                                </div>

                                <div class="form-check form-switch mb-3">
                                    <input class="form-check-input" type="checkbox" name="is_active" id="isActive" {{ $faq->is_active ? 'checked' : '' }}>
