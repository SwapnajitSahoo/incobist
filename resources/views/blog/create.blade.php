...
<div class="container-fluid px-4">
    <div class="my-4">
        <h4 class="mb-0">Add New Insight Blog</h4>
    ...
    <div class="card shadow-sm border-0">
        <div class="card-body p-4">
            <form action="{{ route('admin.insight-blogs.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row gx-4">
                    <div class="col-md-8">
                        <div class="mb-4">
                            <label class="form-label fw-bold">Blog Title <span class="text-danger">*</span></label>
                            <input type="text" name="name" class="form-control form-control-lg" placeholder="Enter title" value="{{ old('name') }}" required>
                        </div>

                        <div class="mb-4">
                            <label class="form-label fw-bold">Content</label>
                            <textarea name="content" id="blog-content" class="form-control" rows="15">{{ old('content') }}</textarea>
                        </div>
                    </div>
