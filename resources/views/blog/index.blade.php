<x-app-layout>
    <div class="container-fluid px-4">
        <div class="d-flex justify-content-between align-items-center my-3">
            <h4 class="mb-0">Insight Blogs</h4>
            <a href="{{ route('admin.insight-blogs.create') }}" class="btn btn-primary btn-sm">+ Add New Blog</a>
        </div>
                        ...
                        <tbody>
                            @forelse($blogs as $blog)
                                <tr>
                                    ...
                                    <td class="px-4 fw-semibold text-dark">{{ $blog->name }}</td>
                                    <td class="px-4"><span
                                            class="badge bg-light text-dark font-weight-normal">{{ $blog->slug }}</span>
                                    </td>
                                    <td class="px-4">
                                        @if($blog->is_active)
                                    ...
                                    <td class="px-4 text-end">
                                        <div class="d-flex justify-content-end align-items-center gap-2">
                                            <a href="{{ route('admin.insight-blogs.edit', $blog->id) }}"
                                            ...
                                            <form action="{{ route('admin.insight-blogs.delete', $blog->id) }}"
