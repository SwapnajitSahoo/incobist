    ...
    <div class="footer-content-wrapper">
        <div class="footer-sections">
            ...
            <div class="footer-section footer-brand-section">
                ...
                <p class="footer-description-text">Join Our Community To Stay up-to-dated With The Latest Technology!
                </p>
                ...
                <div class="footer-social-links">
                    <a href="https://www.linkedin.com/company/incobist/?viewAsMember=true"
                        class="social-btn social-linkedin"><i class="fab fa-linkedin-in"></i></a>
                    <a href="https://www.twitter.com/incobist2001" class="social-btn social-twitter"><i
                            class="fab fa-twitter"></i></a>
                    <a href="https://www.instagram.com/incobist" class="social-btn social-instagram"><i
                            class="fab fa-instagram"></i></a>
                    <a href="https://www.facebook.com/incobist" class="social-btn social-facebook"><i
                            class="fab fa-facebook-f"></i></a>
                    <a href="https://wa.me/9090138408" target="_blank" class="social-btn social-whatsapp"><i
            ...
            <div class="footer-section footer-contact-section">
                ...
                <p class="contact-description-text">Join us on this journey of the discover as we explore the latest
                    trend.</p>
