<x-app-layout>
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title"><i class="fe fe-grid me-2 text-primary"></i>Card Information</h3>
        </div>
 
        <form action="{{ route('admin.industry.cards.store', $industry->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="url" name="card_link"
                               ...
                               value="{{ old('card_link') }}" placeholder="https://...">
            ...
            <div class="card-footer d-flex justify-content-end gap-2">
                ...
                <button type="submit" class="btn btn-primary">
                    <i class="fe fe-save me-1"></i> Save Card
                </button>
            </div>
        </form>
    </div>
