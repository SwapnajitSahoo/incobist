<x-app-layout>
    ...
    <div class="page-header">
        <div>
            <h1 class="page-title">Add Challenge</h1>
            <ol class="breadcrumb">
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title"><i class="fe fe-layers me-2 text-primary"></i>Challenge Information</h3>
        </div>
 
        <form action="{{ route('admin.industry.challenges.store', $industry->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="solution_name"
                               ...
                               value="{{ old('solution_name') }}" placeholder="Enter solution name">
            ...
            <div class="card-footer d-flex justify-content-end gap-2">
                ...
                <button type="submit" class="btn btn-primary">
                    <i class="fe fe-save me-1"></i> Save Challenge
                </button>
            </div>
        </form>
    </div>
