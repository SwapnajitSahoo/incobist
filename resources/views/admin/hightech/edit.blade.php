...
<h4 class="my-3">Edit Hightech Industry</h4>

<div class="card shadow-sm border-0">
<div class="card-body">

<form method="POST" action="{{ route('admin.hightech.update',$industry->id) }}">
@csrf
...
<a href="{{ route('admin.hightech.index') }}" class="btn btn-secondary">Cancel</a>
