<x-app-layout>
    ...
    <div class="container-fluid px-4">
        ...
        <div class="d-flex justify-content-between align-items-center my-4">
            <div>
                <h4 class="mb-0 fw-bold text-dark">Create Menu Item</h4>
                        ...
                        <form action="{{ route('admin.navbar-menu-store') }}" method="POST">
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="title" id="title"
                                        ...
                                        value="{{ old('title') }}" required style="border-radius: 8px; padding: 10px 15px;">
                                    @error('title')
                                ...
                                {{-- SLUG --}}
                                <div class="col-md-6">
                                    <label class="form-label fw-semibold text-muted small text-uppercase mb-2">Slug (Auto)</label>
                                    <input type="text" name="slug" id="slug"
                                        class="form-control @error('slug') is-invalid @enderror bg-light"
                                        value="{{ old('slug') }}" readonly style="border-radius: 8px; padding: 10px 15px;">
                                    @error('slug')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                {{-- URL --}}
                                <div class="col-12">
                                    <label class="form-label fw-semibold text-muted small text-uppercase mb-2">URL Route Preview</label>
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="url" id="url"
                                            ...
                                            value="{{ old('url') }}" readonly style="border-top-right-radius: 8px; border-bottom-right-radius: 8px; padding: 10px 15px;">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="number" name="menu_order"
                                        class="form-control"
                                        value="{{ old('menu_order', 0) }}" min="0" style="border-radius: 8px; padding: 10px 15px;">
                                </div>
                                ...
                                <div class="col-12 d-flex align-items-center mt-3">
                                    <div class="form-check form-switch">
                                        ...
                                        <label class="form-check-label fw-semibold text-muted ms-2" for="is_active">
                                            Enable Visibility
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div class="mt-5 d-flex gap-2">
                                <button type="submit" class="btn btn-primary shadow-sm px-5 py-2" style="border-radius: 8px; font-weight: 500;">
                                    <i class="fe fe-save me-1"></i> Save Menu Item
                                </button>
